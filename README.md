"# sistema-reportes-comunidad"  

> Proyecto desarrollado por un **equipo de 7 integrantes** bajo metodología **Scrum** en sprints intensivos de 3 días.  
> Permite a los ciudadanos de zonas vulnerables reportar problemas comunitarios (basura, baches, alumbrado, seguridad) con geolocalización, seguimiento de estado y autenticación segura.

🔗 **Demo (desarrollo)**: `http://localhost:8000` (requiere entorno local)  
...
git clone https://github.com/tuusuario/sistema-reportes-comunidad.git
...
#    - Editar credenciales en: community_project/settings.py → DATABASES
